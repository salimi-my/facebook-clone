...
function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Fakebook | Privacy Policy</title>
        <meta name='title' content='Fakebook | Privacy Policy' />
        <meta
          name='description'
        ...
        <meta
          property='og:url'
          content='https://fakebook.salimi.my/privacy-policy'
        />
        <meta property='og:title' content='Fakebook | Privacy Policy' />
        <meta
        ...
        <meta
          ...
          content='https://fakebook.salimi.my/privacy-policy'
        />
        <meta property='twitter:title' content='Fakebook | Privacy Policy' />
        <meta
      ...
      <div className='max-w-5xl container m-auto relative'>
        <div className='w-full'>
          ...
          <p className='mb-4'>Last updated: January 29, 2023</p>
          <p className='mb-4'>
          ...
          <h1 className='mb-4 text-[40px] leading-[60px] font-bold'>
            Interpretation and Definitions
          </h1>
          <h2 className='mb-4 text-[32px] leading-[48px] font-bold'>
            Interpretation
          </h2>
          <p className='mb-4'>
          ...
          <ul>
            ...
            <li className='mb-4'>
              <p className='mb-4'>
                ...
                in this Agreement) refers to Fakebook.
              </p>
            </li>
            <li className='mb-4'>
              <p className='mb-4'>
          ...
          <h3 className='mb-4 text-[24px] leading-[36px] font-bold'>
            Personal Data
          </h3>
          <p className='mb-4'>
          ...
          <ul>
            <li className='mb-4'>By email: contact@salimi.my</li>
          </ul>
        </div>
      </div>
    </>
